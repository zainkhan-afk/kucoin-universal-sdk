...
// GetRecentClosedOrdersData struct for GetRecentClosedOrdersData
type GetRecentClosedOrdersData struct {
	// Order ID
	...
	StopPrice int32 `json:"stopPrice,omitempty"`
...
// NewGetRecentClosedOrdersData instantiates a new GetRecentClosedOrdersData object
// This constructor will assign default values to properties that have it defined
func NewGetRecentClosedOrdersData(id string, symbol string, Type_ string, side string, price string, size int32, value string, dealValue string, dealSize int32, stp string, stop string, stopPriceType string, stopTriggered bool, stopPrice int32, timeInForce string, postOnly bool, hidden bool, iceberg bool, leverage string, forceHold bool, closeOrder bool, visibleSize int32, clientOid string, remark string, tags string, isActive bool, cancelExist bool, createdAt int64, updatedAt int64, endAt int64, orderTime int64, settleCurrency string, marginMode string, avgDealPrice string, filledSize int32, filledValue string, status string, reduceOnly bool) *GetRecentClosedOrdersData {
	this := GetRecentClosedOrdersData{}
	this.Id = id
	this.Symbol = symbol
	this.Type = Type_
	this.Side = side
...
// NewGetRecentClosedOrdersDataWithDefaults instantiates a new GetRecentClosedOrdersData object
// This constructor will only assign default values to properties that have it defined,
func NewGetRecentClosedOrdersDataWithDefaults() *GetRecentClosedOrdersData {
	this := GetRecentClosedOrdersData{}
	return &this
}

func (o *GetRecentClosedOrdersData) ToMap() map[string]interface{} {
