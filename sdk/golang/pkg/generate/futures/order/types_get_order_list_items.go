...
// GetOrderListItems struct for GetOrderListItems
...
// NewGetOrderListItems instantiates a new GetOrderListItems object
// This constructor will assign default values to properties that have it defined
func NewGetOrderListItems(id string, symbol string, Type_ string, side string, price string, size int32, value string, dealValue string, dealSize int32, stp string, stop string, stopPriceType string, stopTriggered bool, stopPrice int32, timeInForce string, postOnly bool, hidden bool, iceberg bool, leverage string, forceHold bool, closeOrder bool, visibleSize int32, clientOid string, remark string, tags string, isActive bool, cancelExist bool, createdAt int64, updatedAt int64, endAt int64, orderTime int64, settleCurrency string, marginMode string, avgDealPrice string, status string, filledSize int32, filledValue string, reduceOnly bool) *GetOrderListItems {
...
// NewGetOrderListItemsWithDefaults instantiates a new GetOrderListItems object
// This constructor will only assign default values to properties that have it defined,
func NewGetOrderListItemsWithDefaults() *GetOrderListItems {
	this := GetOrderListItems{}
	return &this
}

func (o *GetOrderListItems) ToMap() map[string]interface{} {
