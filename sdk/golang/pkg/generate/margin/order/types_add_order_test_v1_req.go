...
// AddOrderTestV1Req struct for AddOrderTestV1Req
type AddOrderTestV1Req struct {
	...
	// [Self Trade Prevention](doc://link/pages/5176570) is divided into four strategies: CN, CO, CB , and DC
...
// NewAddOrderTestV1Req instantiates a new AddOrderTestV1Req object
// This constructor will assign default values to properties that have it defined
func NewAddOrderTestV1Req(clientOid string, side string, symbol string) *AddOrderTestV1Req {
	this := AddOrderTestV1Req{}
...
// NewAddOrderTestV1ReqWithDefaults instantiates a new AddOrderTestV1Req object
// This constructor will only assign default values to properties that have it defined,
func NewAddOrderTestV1ReqWithDefaults() *AddOrderTestV1Req {
	this := AddOrderTestV1Req{}
	var Type_ string = "limit"
	this.Type = &Type_
	var timeInForce string = "GTC"
...
func (o *AddOrderTestV1Req) ToMap() map[string]interface{} {
...
type AddOrderTestV1ReqBuilder struct {
	obj *AddOrderTestV1Req
}

func NewAddOrderTestV1ReqBuilder() *AddOrderTestV1ReqBuilder {
	return &AddOrderTestV1ReqBuilder{obj: NewAddOrderTestV1ReqWithDefaults()}
}

// Client Order Id，The ClientOid field is a unique ID created by the user（we recommend using a UUID）, and can only contain numbers, letters, underscores （_）, and hyphens （-）. This field is returned when order information is obtained. You can use clientOid to tag your orders. ClientOid is different from the order ID created by the service provider. Please do not initiate requests using the same clientOid. The maximum length for the ClientOid is 40 characters.  Please remember the orderId created by the service provider, it used to check for updates in order status.
func (builder *AddOrderTestV1ReqBuilder) SetClientOid(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.ClientOid = value
	return builder
}

// specify if the order is to 'buy' or 'sell'
func (builder *AddOrderTestV1ReqBuilder) SetSide(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Side = value
	return builder
}

// symbol
func (builder *AddOrderTestV1ReqBuilder) SetSymbol(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Symbol = value
	return builder
}

// specify if the order is an 'limit' order or 'market' order.   The type of order you specify when you place your order determines whether or not you need to request other parameters and also affects the execution of the matching engine.  When placing a limit order, you must specify a price and size. The system will try to match the order according to market price or a price better than market price. If the order cannot be immediately matched, it will stay in the order book until it is matched or the user cancels.  Unlike limit orders, the price for market orders fluctuates with market prices. When placing a market order, you do not need to specify a price, you only need to specify a quantity. Market orders are filled immediately and will not enter the order book. All market orders are takers and a taker fee will be charged.
func (builder *AddOrderTestV1ReqBuilder) SetType(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Type = &value
	return builder
}

// [Self Trade Prevention](doc://link/pages/5176570) is divided into four strategies: CN, CO, CB , and DC
func (builder *AddOrderTestV1ReqBuilder) SetStp(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Stp = &value
	return builder
}

// Specify price for order  When placing a limit order, the price must be based on priceIncrement for the trading pair. The price increment (priceIncrement) is the price precision for the trading pair. For example, for the BTC-USDT trading pair, the priceIncrement is 0.00001000. So the price for your orders cannot be less than 0.00001000 and must be a multiple of priceIncrement. Otherwise, the order will return an invalid priceIncrement error.
func (builder *AddOrderTestV1ReqBuilder) SetPrice(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Price = &value
	return builder
}

// Specify quantity for order  When **type** is limit, size refers to the amount of trading targets (the asset name written in front) for the trading pair. Teh Size must be based on the baseIncrement of the trading pair. The baseIncrement represents the precision for the trading pair. The size of an order must be a positive-integer multiple of baseIncrement and must be between baseMinSize and baseMaxSize.  When **type** is market, select one out of two: size or funds
func (builder *AddOrderTestV1ReqBuilder) SetSize(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Size = &value
	return builder
}

// [Time in force](doc://link/pages/5176570) is a special strategy used during trading
func (builder *AddOrderTestV1ReqBuilder) SetTimeInForce(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.TimeInForce = &value
	return builder
}

// passive order labels, this is disabled when the order timing strategy is IOC or FOK
func (builder *AddOrderTestV1ReqBuilder) SetPostOnly(value bool) *AddOrderTestV1ReqBuilder {
	builder.obj.PostOnly = &value
	return builder
}

// Hidden or not (not shown in order book)
func (builder *AddOrderTestV1ReqBuilder) SetHidden(value bool) *AddOrderTestV1ReqBuilder {
	builder.obj.Hidden = &value
	return builder
}

// Whether or not only visible portions of orders are shown in iceberg orders
func (builder *AddOrderTestV1ReqBuilder) SetIceberg(value bool) *AddOrderTestV1ReqBuilder {
	builder.obj.Iceberg = &value
	return builder
}

// Maximum visible quantity in iceberg orders
func (builder *AddOrderTestV1ReqBuilder) SetVisibleSize(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.VisibleSize = &value
	return builder
}

// Cancel after n seconds，the order timing strategy is GTT
func (builder *AddOrderTestV1ReqBuilder) SetCancelAfter(value int64) *AddOrderTestV1ReqBuilder {
	builder.obj.CancelAfter = &value
	return builder
}

// When **type** is market, select one out of two: size or funds
func (builder *AddOrderTestV1ReqBuilder) SetFunds(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.Funds = &value
	return builder
}

// When Margin Account has inefficient balance, our system autoborrows inefficient assets and opens positions according to the lowest market interest rate.
func (builder *AddOrderTestV1ReqBuilder) SetAutoBorrow(value bool) *AddOrderTestV1ReqBuilder {
	builder.obj.AutoBorrow = &value
	return builder
}

// AutoPay allows returning borrowed assets when you close a position. Our system automatically triggers the repayment and the maximum repayment amount equals to the filled-order amount.
func (builder *AddOrderTestV1ReqBuilder) SetAutoRepay(value bool) *AddOrderTestV1ReqBuilder {
	builder.obj.AutoRepay = &value
	return builder
}

// The type of trading, including cross (cross mode) and isolated (isolated mode). It is set at cross by default.
func (builder *AddOrderTestV1ReqBuilder) SetMarginModel(value string) *AddOrderTestV1ReqBuilder {
	builder.obj.MarginModel = &value
	return builder
}

func (builder *AddOrderTestV1ReqBuilder) Build() *AddOrderTestV1Req {
	return builder.obj
}
