...
// GetClosedOrdersItems struct for GetClosedOrdersItems
type GetClosedOrdersItems struct {
...
// NewGetClosedOrdersItems instantiates a new GetClosedOrdersItems object
// This constructor will assign default values to properties that have it defined
func NewGetClosedOrdersItems(id string, symbol string, opType string, Type_ string, side string, price string, size string, funds string, dealSize string, dealFunds string, fee string, feeCurrency string, stopTriggered bool, stopPrice string, timeInForce string, postOnly bool, hidden bool, iceberg bool, visibleSize string, cancelAfter int32, channel string, clientOid string, cancelExist bool, createdAt int64, lastUpdatedAt int64, tradeType string, inOrderBook bool, cancelledSize string, cancelledFunds string, remainSize string, remainFunds string, tax string, active bool) *GetClosedOrdersItems {
	this := GetClosedOrdersItems{}
	this.Id = id
	this.Symbol = symbol
	this.OpType = opType
	this.Type = Type_
...
// NewGetClosedOrdersItemsWithDefaults instantiates a new GetClosedOrdersItems object
// This constructor will only assign default values to properties that have it defined,
func NewGetClosedOrdersItemsWithDefaults() *GetClosedOrdersItems {
	this := GetClosedOrdersItems{}
	return &this
}

func (o *GetClosedOrdersItems) ToMap() map[string]interface{} {
