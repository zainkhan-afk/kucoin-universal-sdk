...
func NewAddOrderReq(clientOid string, side string, symbol string) *AddOrderReq {
	this := AddOrderReq{}
...
// true - isolated margin ,false - cross margin. defult as false
func (builder *AddOrderReqBuilder) SetIsIsolated(value bool) *AddOrderReqBuilder {
	builder.obj.IsIsolated = &value
	return builder
}

// When Margin Account has inefficient balance, our system autoborrows inefficient assets and opens positions according to the lowest market interest rate.
func (builder *AddOrderReqBuilder) SetAutoBorrow(value bool) *AddOrderReqBuilder {
	builder.obj.AutoBorrow = &value
	return builder
}

// AutoPay allows returning borrowed assets when you close a position. Our system automatically triggers the repayment and the maximum repayment amount equals to the filled-order amount.
func (builder *AddOrderReqBuilder) SetAutoRepay(value bool) *AddOrderReqBuilder {
