...
// GetOpenOrdersData struct for GetOpenOrdersData
...
func NewGetOpenOrdersData(id string, symbol string, opType string, Type_ string, side string, price string, size string, funds string, dealSize string, dealFunds string, fee string, feeCurrency string, stopTriggered bool, stopPrice string, timeInForce string, postOnly bool, hidden bool, iceberg bool, visibleSize string, cancelAfter int32, channel string, clientOid string, cancelExist bool, createdAt int64, lastUpdatedAt int64, tradeType string, inOrderBook bool, cancelledSize string, cancelledFunds string, remainSize string, remainFunds string, tax string, active bool) *GetOpenOrdersData {
...
// NewGetOpenOrdersDataWithDefaults instantiates a new GetOpenOrdersData object
// This constructor will only assign default values to properties that have it defined,
func NewGetOpenOrdersDataWithDefaults() *GetOpenOrdersData {
	this := GetOpenOrdersData{}
	return &this
}

func (o *GetOpenOrdersData) ToMap() map[string]interface{} {
