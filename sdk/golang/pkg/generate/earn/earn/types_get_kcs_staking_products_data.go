...
// GetKcsStakingProductsData struct for GetKcsStakingProductsData
type GetKcsStakingProductsData struct {
	// Product ID
...
// NewGetKcsStakingProductsData instantiates a new GetKcsStakingProductsData object
// This constructor will assign default values to properties that have it defined
func NewGetKcsStakingProductsData(id string, currency string, category string, Type_ string, precision int32, productUpperLimit string, userUpperLimit string, userLowerLimit string, redeemPeriod int32, lockStartTime int64, applyStartTime int64, returnRate string, incomeCurrency string, earlyRedeemSupported int32, productRemainAmount string, status string, redeemType string, incomeReleaseType string, interestDate int64, duration int32, newUserOnly int32) *GetKcsStakingProductsData {
	this := GetKcsStakingProductsData{}
	this.Id = id
...
// NewGetKcsStakingProductsDataWithDefaults instantiates a new GetKcsStakingProductsData object
// This constructor will only assign default values to properties that have it defined,
func NewGetKcsStakingProductsDataWithDefaults() *GetKcsStakingProductsData {
	this := GetKcsStakingProductsData{}
	return &this
}

func (o *GetKcsStakingProductsData) ToMap() map[string]interface{} {
