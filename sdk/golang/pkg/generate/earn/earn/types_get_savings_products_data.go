...
// GetSavingsProductsData struct for GetSavingsProductsData
type GetSavingsProductsData struct {
	// Product ID
...
// NewGetSavingsProductsData instantiates a new GetSavingsProductsData object
// This constructor will assign default values to properties that have it defined
func NewGetSavingsProductsData(id string, currency string, category string, Type_ string, precision int32, productUpperLimit string, userUpperLimit string, userLowerLimit string, redeemPeriod int32, lockStartTime int64, lockEndTime int64, applyStartTime int64, applyEndTime int64, returnRate string, incomeCurrency string, earlyRedeemSupported int32, productRemainAmount string, status string, redeemType string, incomeReleaseType string, interestDate int64, duration int32, newUserOnly int32) *GetSavingsProductsData {
	this := GetSavingsProductsData{}
	this.Id = id
...
// NewGetSavingsProductsDataWithDefaults instantiates a new GetSavingsProductsData object
// This constructor will only assign default values to properties that have it defined,
func NewGetSavingsProductsDataWithDefaults() *GetSavingsProductsData {
	this := GetSavingsProductsData{}
	return &this
}

func (o *GetSavingsProductsData) ToMap() map[string]interface{} {
