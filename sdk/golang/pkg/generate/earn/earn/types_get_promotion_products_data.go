...
// GetPromotionProductsData struct for GetPromotionProductsData
type GetPromotionProductsData struct {
	// Product ID
...
// NewGetPromotionProductsData instantiates a new GetPromotionProductsData object
// This constructor will assign default values to properties that have it defined
func NewGetPromotionProductsData(id string, currency string, category string, Type_ string, precision int32, productUpperLimit string, userUpperLimit string, userLowerLimit string, redeemPeriod int32, lockStartTime int64, lockEndTime int64, applyStartTime int64, applyEndTime int64, returnRate string, incomeCurrency string, earlyRedeemSupported int32, productRemainAmount string, status string, redeemType string, incomeReleaseType string, interestDate int64, duration int32, newUserOnly int32) *GetPromotionProductsData {
	this := GetPromotionProductsData{}
	this.Id = id
...
// NewGetPromotionProductsDataWithDefaults instantiates a new GetPromotionProductsData object
// This constructor will only assign default values to properties that have it defined,
func NewGetPromotionProductsDataWithDefaults() *GetPromotionProductsData {
	this := GetPromotionProductsData{}
	return &this
}

func (o *GetPromotionProductsData) ToMap() map[string]interface{} {
