...
func NewAddOrderTestReq(side string, symbol string, Type_ string) *AddOrderTestReq {
...
// Order tag, length cannot exceed 20 characters (ASCII)
func (builder *AddOrderTestReqBuilder) SetTags(value string) *AddOrderTestReqBuilder {
