...
class FuturesPrivateWsTest(unittest.TestCase):
    def setUp(self):
        ...
        self.api = kucoin_ws_client.new_futures_private_ws()
        self.api.start()
    ...
    def test_private_all_order(self):
        self._test_subscription(self.api.all_order)

    def test_private_all_position(self):
        self._test_subscription(self.api.all_position)

    def test_private_balance(self):
        self._test_subscription(self.api.balance)

    def test_private_cross_leverage(self):
        self._test_subscription(self.api.cross_leverage)

    def test_private_margin_mode(self):
        self._test_subscription(self.api.margin_mode)

    def test_private_order(self):
        self._test_subscription(self.api.order, "XBTUSDTM")

    def test_private_position(self):
        self._test_subscription(self.api.position, "DOGEUSDTM")

    def test_private_stop_orders(self):
        self._test_subscription(self.api.stop_orders)