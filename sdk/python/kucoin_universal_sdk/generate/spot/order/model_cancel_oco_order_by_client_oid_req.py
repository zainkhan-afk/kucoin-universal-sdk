...
class CancelOcoOrderByClientOidReq(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> Optional[CancelOcoOrderByClientOidReq]:
    ...
    def from_dict(
        ...
        obj: Optional[Dict[str,
                           Any]]) -> Optional[CancelOcoOrderByClientOidReq]:
        if obj is None:
            return None
...
class CancelOcoOrderByClientOidReqBuilder:
    ...
    def set_client_oid(self,
                       value: str) -> CancelOcoOrderByClientOidReqBuilder:
        """
    ...
    def build(self) -> CancelOcoOrderByClientOidReq:
        return CancelOcoOrderByClientOidReq(**self.obj)
