...
class BatchCancelStopOrderResp(BaseModel, Response):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[BatchCancelStopOrderResp]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[BatchCancelStopOrderResp]:
        if obj is None:
            return None
