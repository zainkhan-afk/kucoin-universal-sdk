...
class AddOrderSyncResp(BaseModel, Response):
    """
    AddOrderSyncResp
    ...
    __properties: ClassVar[List[str]] = [
        ...
        "remainSize", "canceledSize", "status", "matchTime"
    ]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[AddOrderSyncResp]:
