...
class BatchAddOrdersSyncOrderList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[BatchAddOrdersSyncOrderList]:
    ...
    def from_dict(
        ...
        obj: Optional[Dict[str,
                           Any]]) -> Optional[BatchAddOrdersSyncOrderList]:
        if obj is None:
            return None
...
class BatchAddOrdersSyncOrderListBuilder:
    ...
    def set_symbol(self, value: str) -> BatchAddOrdersSyncOrderListBuilder:
        """
        symbol
        """
    ...
    def set_time_in_force(
        self, value: BatchAddOrdersSyncOrderList.TimeInForceEnum
    ) -> BatchAddOrdersSyncOrderListBuilder:
        """
        [Time in force](https://www.kucoin.com/docs-new/doc-338146) is a special strategy used during trading
        """
    ...
    def set_price(self, value: str) -> BatchAddOrdersSyncOrderListBuilder:
        """
    ...
    def set_stp(
        self, value: BatchAddOrdersSyncOrderList.StpEnum
    ) -> BatchAddOrdersSyncOrderListBuilder:
        """
        [Self Trade Prevention](https://www.kucoin.com/docs-new/doc-338146) is divided into four strategies: CN, CO, CB , and DC
        """
    ...
    def set_post_only(self, value: bool) -> BatchAddOrdersSyncOrderListBuilder:
        """
        passive order labels, this is disabled when the order timing strategy is IOC or FOK
        """
    ...
    def set_visible_size(self,
                         value: str) -> BatchAddOrdersSyncOrderListBuilder:
        """
    ...
    def set_tags(self, value: str) -> BatchAddOrdersSyncOrderListBuilder:
        """
    ...
    def set_remark(self, value: str) -> BatchAddOrdersSyncOrderListBuilder:
        """
        Order placement remarks, length cannot exceed 20 characters (ASCII)
        """
    ...
    def set_funds(self, value: str) -> BatchAddOrdersSyncOrderListBuilder:
        """
        When **type** is market, select one out of two: size or funds
        """
    ...
    def build(self) -> BatchAddOrdersSyncOrderList:
        return BatchAddOrdersSyncOrderList(**self.obj)
