...
class GetStopOrderByOrderIdResp(BaseModel, Response):
    """
    the details
    ...
    __properties: ClassVar[List[str]] = [
        ...
        "domainId", "tradeSource", "tradeType", "feeCurrency", "takerFeeRate",
        "makerFeeRate", "createdAt", "stop", "stopTriggerTime", "stopPrice",
        "orderTime"
    ]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetStopOrderByOrderIdResp]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetStopOrderByOrderIdResp]:
        if obj is None:
            return None
