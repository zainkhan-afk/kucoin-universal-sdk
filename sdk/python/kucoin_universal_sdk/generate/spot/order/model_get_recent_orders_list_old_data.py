...
class GetRecentOrdersListOldData(BaseModel):
    """
    GetRecentOrdersListOldData
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetRecentOrdersListOldData]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetRecentOrdersListOldData]:
        if obj is None:
            return None
