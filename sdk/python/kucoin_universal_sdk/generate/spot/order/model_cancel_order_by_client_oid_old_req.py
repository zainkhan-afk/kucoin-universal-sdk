...
class CancelOrderByClientOidOldReq(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> Optional[CancelOrderByClientOidOldReq]:
    ...
    def from_dict(
        ...
        obj: Optional[Dict[str,
                           Any]]) -> Optional[CancelOrderByClientOidOldReq]:
        if obj is None:
            return None
...
class CancelOrderByClientOidOldReqBuilder:
    ...
    def build(self) -> CancelOrderByClientOidOldReq:
        return CancelOrderByClientOidOldReq(**self.obj)
