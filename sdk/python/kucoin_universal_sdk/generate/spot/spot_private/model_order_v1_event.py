...
class OrderV1Event(BaseModel):
    ...
    client_oid: Optional[str] = Field(
        ...
        alias="clientOid")
    filled_size: Optional[str] = Field(default=None, alias="filledSize")
    ...
    order_type: Optional[OrderTypeEnum] = Field(default=None,
                                                alias="orderType")
    origin_size: Optional[str] = Field(default=None, alias="originSize")
    ...
    old_size: Optional[str] = Field(default=None,
                                    ...
                                    alias="oldSize")
    fee_type: Optional[FeeTypeEnum] = Field(default=None, alias="feeType")
    liquidity: Optional[LiquidityEnum] = None
