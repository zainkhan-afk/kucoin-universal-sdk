...
class SymbolSnapshotDataMarketChange1h(BaseModel):
    """
    SymbolSnapshotDataMarketChange1h
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> Optional[SymbolSnapshotDataMarketChange1h]:
    ...
    ) -> Optional[SymbolSnapshotDataMarketChange1h]:
        if obj is None:
            return None
