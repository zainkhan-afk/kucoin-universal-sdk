...
class SymbolSnapshotDataMarketChange24h(BaseModel):
    """
    SymbolSnapshotDataMarketChange24h
    ...
    @classmethod
    def from_json(
            cls, json_str: str) -> Optional[SymbolSnapshotDataMarketChange24h]:
    ...
    ) -> Optional[SymbolSnapshotDataMarketChange24h]:
        if obj is None:
            return None
