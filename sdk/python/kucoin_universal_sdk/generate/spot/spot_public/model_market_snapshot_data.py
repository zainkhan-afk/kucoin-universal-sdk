...
class MarketSnapshotData(BaseModel):
    ...
    Attributes:
        ...
        market_change4h (MarketSnapshotDataMarketChange4h): 
        markets (list[str]): 
        open (float): 
        quote_currency (str): 
        sell (float): 
        site_types (list[str]): 
        sort (int): sorting number
        symbol (str): 
        symbol_code (str): 
    ...
    market_change24h: Optional[MarketSnapshotDataMarketChange24h] = Field(
        default=None, alias="marketChange24h")
    market_change4h: Optional[MarketSnapshotDataMarketChange4h] = Field(
    ...
    sort: Optional[int] = Field(default=None, description="sorting number")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[MarketSnapshotData]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[MarketSnapshotData]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            obj.get("market"),
            "marketChange1h":
            MarketSnapshotDataMarketChange1h.from_dict(obj["marketChange1h"])
            if obj.get("marketChange1h") is not None else None,
            "marketChange24h":
            MarketSnapshotDataMarketChange24h.from_dict(obj["marketChange24h"])
            if obj.get("marketChange24h") is not None else None,
            "marketChange4h":
            MarketSnapshotDataMarketChange4h.from_dict(obj["marketChange4h"])
