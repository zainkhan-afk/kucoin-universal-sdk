...
class AddOrderTestResp(BaseModel, Response):
    ...
    Attributes:
        ...
        loan_apply_id (str): Borrowed amount. The field is returned only after placing the order under the mode of Auto-Borrow.
        borrow_size (float): ID of the borrowing response. The field is returned only after placing the order under the mode of Auto-Borrow.
    ...
    loan_apply_id: Optional[str] = Field(
        ...
        alias="loanApplyId")
    borrow_size: Optional[float] = Field(
        default=None,
        description=
