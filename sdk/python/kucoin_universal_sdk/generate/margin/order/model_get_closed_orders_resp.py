...
class GetClosedOrdersResp(BaseModel, Response):
    """
    GetClosedOrdersResp
    ...
    Attributes:
        ...
        items (list[GetClosedOrdersItems]): 
    """
    ...
    last_id: Optional[int] = Field(
        ...
        alias="lastId")
    items: Optional[List[GetClosedOrdersItems]] = None

    __properties: ClassVar[List[str]] = ["lastId", "items"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetClosedOrdersResp]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetClosedOrdersResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            obj.get("lastId"),
            "items":
            [GetClosedOrdersItems.from_dict(_item) for _item in obj["items"]]
