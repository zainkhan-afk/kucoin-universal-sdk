...
class GetInterestHistoryReq(BaseModel):
    ...
    __properties: ClassVar[List[str]] = [
        "currency", "isIsolated", "symbol", "startTime", "endTime",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetInterestHistoryReq]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetInterestHistoryReq]:
        if obj is None:
            return None
...
class GetInterestHistoryReqBuilder:
    ...
    def set_currency(self, value: str) -> GetInterestHistoryReqBuilder:
        """
        currency
        """
    ...
    def set_is_isolated(self, value: bool) -> GetInterestHistoryReqBuilder:
        """
    ...
    def set_symbol(self, value: str) -> GetInterestHistoryReqBuilder:
        """
    ...
    def set_start_time(self, value: int) -> GetInterestHistoryReqBuilder:
        """
        The start and end times are not restricted. If the start time is empty or less than 1680278400000, the default value is set to 1680278400000 (April 1, 2023, 00:00:00)
        """
    ...
    def set_end_time(self, value: int) -> GetInterestHistoryReqBuilder:
        """
        End time
        """
    ...
    def set_current_page(self, value: int) -> GetInterestHistoryReqBuilder:
        """
        Current query page, with a starting value of 1. Default:1 
        """
    ...
    def set_page_size(self, value: int) -> GetInterestHistoryReqBuilder:
        """
        Number of results per page. Default is 50, minimum is 10, maximum is 500
        """
    ...
    def build(self) -> GetInterestHistoryReq:
        return GetInterestHistoryReq(**self.obj)
