...
class GetPrivateFundingHistoryResp(BaseModel, Response):
    """
    GetPrivateFundingHistoryResp

    Attributes:
        data_list (list[GetPrivateFundingHistoryDataList]): 
        has_more (bool): Whether there are more pages 
    """

    common_response: Optional[RestResponse] = Field(
        default=None, description="Common response")
    data_list: Optional[List[GetPrivateFundingHistoryDataList]] = Field(
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> Optional[GetPrivateFundingHistoryResp]:
    ...
    def from_dict(
        ...
        obj: Optional[Dict[str,
                           Any]]) -> Optional[GetPrivateFundingHistoryResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dataList": [
                GetPrivateFundingHistoryDataList.from_dict(_item)
