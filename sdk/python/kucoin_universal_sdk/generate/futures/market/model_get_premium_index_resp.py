...
class GetPremiumIndexResp(BaseModel, Response):
    """
    GetPremiumIndexResp

    Attributes:
        data_list (list[GetPremiumIndexDataList]): 
        has_more (bool): Whether there are more pages
    """

    common_response: Optional[RestResponse] = Field(
        default=None, description="Common response")
    data_list: Optional[List[GetPremiumIndexDataList]] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetPremiumIndexResp]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetPremiumIndexResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dataList": [
                GetPremiumIndexDataList.from_dict(_item)
