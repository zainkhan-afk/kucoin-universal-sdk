...
class GetInterestRateIndexReq(BaseModel):
    ...
    Attributes:
        symbol (str): Symbol of the contract, Please refer to [Get Symbol endpoint: fundingBaseSymbol, fundingQuoteSymbol, fundingBaseSymbol1M, fundingQuoteSymbol1M](apidog://link/endpoint/3470220) 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetInterestRateIndexReq]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetInterestRateIndexReq]:
        if obj is None:
            return None
...
class GetInterestRateIndexReqBuilder:
    ...
    def set_offset(self, value: int) -> GetInterestRateIndexReqBuilder:
        """
        Start offset. The unique attribute of the last returned result of the last request. The data of the first page will be returned by default.
        """
    ...
    def build(self) -> GetInterestRateIndexReq:
        return GetInterestRateIndexReq(**self.obj)
