...
class GetPremiumIndexDataList(BaseModel):
    """
    ...
    time_point: Optional[int] = Field(default=None,
                                      ...
                                      alias="timePoint")
    value: Optional[float] = Field(default=None, description="Premium index")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetPremiumIndexDataList]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetPremiumIndexDataList]:
        if obj is None:
            return None
