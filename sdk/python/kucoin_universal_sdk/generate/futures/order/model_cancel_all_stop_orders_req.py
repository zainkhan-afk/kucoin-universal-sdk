...
class CancelAllStopOrdersReq(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[CancelAllStopOrdersReq]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[CancelAllStopOrdersReq]:
        if obj is None:
            return None
...
class CancelAllStopOrdersReqBuilder:
    ...
    def build(self) -> CancelAllStopOrdersReq:
        return CancelAllStopOrdersReq(**self.obj)
