...
class GetOrderListResp(BaseModel, Response):
    """
    GetOrderListResp
    ...
    items: Optional[List[GetOrderListItems]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetOrderListResp]:
    ...
    def from_dict(cls, obj: Optional[Dict[str,
        ...
        _obj = cls.model_validate({
            ...
            obj.get("totalPage"),
            "items":
            [GetOrderListItems.from_dict(_item) for _item in obj["items"]]
