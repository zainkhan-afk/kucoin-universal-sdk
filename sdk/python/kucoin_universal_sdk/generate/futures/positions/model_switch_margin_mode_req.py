...
class SwitchMarginModeReq(BaseModel):
    """
    SwitchMarginModeReq
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[SwitchMarginModeReq]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[SwitchMarginModeReq]:
        if obj is None:
            return None
...
class SwitchMarginModeReqBuilder:
    ...
    def set_margin_mode(
        self, value: SwitchMarginModeReq.MarginModeEnum
    ...
    def build(self) -> SwitchMarginModeReq:
        return SwitchMarginModeReq(**self.obj)
