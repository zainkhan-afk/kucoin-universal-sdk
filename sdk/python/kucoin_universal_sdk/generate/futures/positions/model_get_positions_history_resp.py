...
class GetPositionsHistoryResp(BaseModel, Response):
    """
    ...
    Attributes:
        ...
        total_num (int): Total number of results 
        total_page (int): Total number of pages 
        items (list[GetPositionsHistoryItems]): 
    """
    ...
    total_page: Optional[int] = Field(default=None,
                                      ...
                                      alias="totalPage")
    items: Optional[List[GetPositionsHistoryItems]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetPositionsHistoryResp]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetPositionsHistoryResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            obj.get("totalPage"),
            "items": [
                GetPositionsHistoryItems.from_dict(_item)
