...
class GetCrossMarginLeverageResp(BaseModel, Response):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetCrossMarginLeverageResp]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetCrossMarginLeverageResp]:
        if obj is None:
            return None
