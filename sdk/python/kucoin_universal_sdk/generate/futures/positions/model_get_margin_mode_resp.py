...
class GetMarginModeResp(BaseModel, Response):
    """
    GetMarginModeResp
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetMarginModeResp]:
    ...
    @classmethod
    def from_dict(
            cls, obj: Optional[Dict[str, Any]]) -> Optional[GetMarginModeResp]:
        if obj is None:
            return None
