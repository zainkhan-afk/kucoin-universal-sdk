...
class GetWithdrawalQuotasReq(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetWithdrawalQuotasReq]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetWithdrawalQuotasReq]:
        if obj is None:
            return None
...
class GetWithdrawalQuotasReqBuilder:
    ...
    def set_currency(self, value: str) -> GetWithdrawalQuotasReqBuilder:
        """
        currency
        """
    ...
    def set_chain(self, value: str) -> GetWithdrawalQuotasReqBuilder:
        """
        The chainId of currency, e.g. The available value for USDT are OMNI, ERC20, TRC20, default is ERC20. The available value for BTC are Native, Segwit, TRC20, the parameters are bech32, btc, trx, default is Native. This only apply for multi-chain currency, and there is no need for single chain currency.
        """
    ...
    def build(self) -> GetWithdrawalQuotasReq:
        return GetWithdrawalQuotasReq(**self.obj)
