...
class GetWithdrawalHistoryOldReq(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetWithdrawalHistoryOldReq]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetWithdrawalHistoryOldReq]:
        if obj is None:
            return None
...
class GetWithdrawalHistoryOldReqBuilder:
    ...
    def set_currency(self, value: str) -> GetWithdrawalHistoryOldReqBuilder:
        """
        currency
        """
    ...
    def set_status(
        self, value: GetWithdrawalHistoryOldReq.StatusEnum
    ...
    def set_current_page(self,
                         value: int) -> GetWithdrawalHistoryOldReqBuilder:
        """
    ...
    def set_page_size(self, value: int) -> GetWithdrawalHistoryOldReqBuilder:
        """
        Number of results per request. Minimum is 10, maximum is 500.
        """
    ...
    def build(self) -> GetWithdrawalHistoryOldReq:
        return GetWithdrawalHistoryOldReq(**self.obj)
