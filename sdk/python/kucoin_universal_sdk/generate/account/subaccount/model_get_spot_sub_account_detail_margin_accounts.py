...
class GetSpotSubAccountDetailMarginAccounts(BaseModel):
    """
    GetSpotSubAccountDetailMarginAccounts
    ...
    def from_json(
            cls,
            json_str: str) -> Optional[GetSpotSubAccountDetailMarginAccounts]:
    ...
    ) -> Optional[GetSpotSubAccountDetailMarginAccounts]:
        if obj is None:
            return None
