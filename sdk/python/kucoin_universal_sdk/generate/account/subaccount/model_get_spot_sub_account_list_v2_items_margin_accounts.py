...
class GetSpotSubAccountListV2ItemsMarginAccounts(BaseModel):
    """
    GetSpotSubAccountListV2ItemsMarginAccounts
    ...
    def from_json(
            cls, json_str: str
    ) -> Optional[GetSpotSubAccountListV2ItemsMarginAccounts]:
