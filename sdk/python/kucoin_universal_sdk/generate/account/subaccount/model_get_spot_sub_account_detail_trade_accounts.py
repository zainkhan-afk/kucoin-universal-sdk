...
class GetSpotSubAccountDetailTradeAccounts(BaseModel):
    """
    GetSpotSubAccountDetailTradeAccounts
    ...
    def from_json(
            cls,
            json_str: str) -> Optional[GetSpotSubAccountDetailTradeAccounts]:
    ...
    ) -> Optional[GetSpotSubAccountDetailTradeAccounts]:
        if obj is None:
            return None
