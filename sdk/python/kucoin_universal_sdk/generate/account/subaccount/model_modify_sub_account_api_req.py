...
class ModifySubAccountApiReq(BaseModel):
    ...
    Attributes:
        ...
        api_key (str): API-Key(Sub-account APIKey)
    """
    ...
    api_key: Optional[str] = Field(default=None,
                                   description="API-Key(Sub-account APIKey)",
                                   alias="apiKey")

    __properties: ClassVar[List[str]] = [
        "passphrase", "permission", "ipWhitelist", "expire", "subName",
        "apiKey"
    ]
    ...
    def from_dict(
        ...
        _obj = cls.model_validate({
            ...
            ModifySubAccountApiReq.ExpireEnum.T_1,
            "subName":
            obj.get("subName"),
            "apiKey":
            obj.get("apiKey")
...
class ModifySubAccountApiReqBuilder:
    ...
    def set_passphrase(self, value: str) -> ModifySubAccountApiReqBuilder:
        """
        Password(Must contain 7-32 characters. Cannot contain any spaces.)
        """
    ...
    def set_ip_whitelist(self, value: str) -> ModifySubAccountApiReqBuilder:
        """
        IP whitelist(You may add up to 20 IPs. Use a halfwidth comma to each IP)
        """
    ...
    def set_expire(
        self, value: ModifySubAccountApiReq.ExpireEnum
    ...
    def set_sub_name(self, value: str) -> ModifySubAccountApiReqBuilder:
        """
