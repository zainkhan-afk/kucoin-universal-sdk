...
class GetSpotSubAccountDetailMainAccounts(BaseModel):
    """
    GetSpotSubAccountDetailMainAccounts
    ...
    def from_json(
            cls,
            json_str: str) -> Optional[GetSpotSubAccountDetailMainAccounts]:
    ...
    ) -> Optional[GetSpotSubAccountDetailMainAccounts]:
        if obj is None:
            return None
