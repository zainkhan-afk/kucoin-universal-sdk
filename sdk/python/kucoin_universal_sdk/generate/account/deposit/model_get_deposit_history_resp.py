...
class GetDepositHistoryResp(BaseModel, Response):
    """
    ...
    Attributes:
        ...
        items (list[GetDepositHistoryItems]): 
    """
    ...
    total_page: Optional[int] = Field(default=None,
                                      ...
                                      alias="totalPage")
    items: Optional[List[GetDepositHistoryItems]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetDepositHistoryResp]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetDepositHistoryResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            obj.get("totalPage"),
            "items": [
                GetDepositHistoryItems.from_dict(_item)
