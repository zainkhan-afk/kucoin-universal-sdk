...
class GetDepositHistoryOldResp(BaseModel, Response):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetDepositHistoryOldResp]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetDepositHistoryOldResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            obj.get("totalPage"),
            "items": [
                GetDepositHistoryOldItems.from_dict(_item)
