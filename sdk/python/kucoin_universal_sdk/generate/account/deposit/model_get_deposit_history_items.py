...
class GetDepositHistoryItems(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = [
        "currency", "chain", "status", "address", "memo", "isInner", "amount",
        "fee", "walletTxId", "createdAt", "updatedAt", "remark", "arrears"
    ]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetDepositHistoryItems]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetDepositHistoryItems]:
        if obj is None:
            return None
