...
class GetDepositAddressV1Req(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetDepositAddressV1Req]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetDepositAddressV1Req]:
        if obj is None:
            return None
...
class GetDepositAddressV1ReqBuilder:
    ...
    def set_currency(self, value: str) -> GetDepositAddressV1ReqBuilder:
        """
        currency
        """
    ...
    def set_chain(self, value: str) -> GetDepositAddressV1ReqBuilder:
        """
        The chainId of currency, e.g. The available value for USDT are OMNI, ERC20, TRC20, default is ERC20. The available value for BTC are Native, Segwit, TRC20, the parameters are bech32, btc, trx, default is Native. This only apply for multi-chain currency, and there is no need for single chain currency.
        """
    ...
    def build(self) -> GetDepositAddressV1Req:
        return GetDepositAddressV1Req(**self.obj)
