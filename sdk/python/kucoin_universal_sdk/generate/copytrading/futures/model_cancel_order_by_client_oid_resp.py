...
class CancelOrderByClientOidResp(BaseModel, Response):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[CancelOrderByClientOidResp]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[CancelOrderByClientOidResp]:
        if obj is None:
            return None
