...
class ModifyIsolatedMarginRiskLimtResp(BaseModel, Response):
    """
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> Optional[ModifyIsolatedMarginRiskLimtResp]:
    ...
    ) -> Optional[ModifyIsolatedMarginRiskLimtResp]:
        if obj is None:
            return None
