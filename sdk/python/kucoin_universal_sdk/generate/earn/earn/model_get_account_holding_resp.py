...
class GetAccountHoldingResp(BaseModel, Response):
    """
    ...
    total_num: Optional[int] = Field(default=None,
                                     ...
                                     alias="totalNum")
    items: Optional[List[GetAccountHoldingItems]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetAccountHoldingResp]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetAccountHoldingResp]:
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            obj.get("totalNum"),
            "items": [
                GetAccountHoldingItems.from_dict(_item)
