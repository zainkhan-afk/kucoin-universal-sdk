...
class GetKcsStakingProductsData(BaseModel):
    """
    GetKcsStakingProductsData

    Attributes:
        id (str): Product ID
        currency (str): currency
        category (CategoryEnum): Product category: KCS_STAKING
    ...
    category: Optional[CategoryEnum] = Field(
        default=None, description="Product category: KCS_STAKING")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetKcsStakingProductsData]:
    ...
    def from_dict(
            ...
            obj: Optional[Dict[str,
                               Any]]) -> Optional[GetKcsStakingProductsData]:
        if obj is None:
            return None
