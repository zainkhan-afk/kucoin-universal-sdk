...
class GetStakingProductsData(BaseModel):
    """
    GetStakingProductsData
    ...
    category: Optional[CategoryEnum] = Field(
        default=None, description="Product category: STAKING")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[GetStakingProductsData]:
    ...
    def from_dict(
            cls, obj: Optional[Dict[str,
                                    Any]]) -> Optional[GetStakingProductsData]:
        if obj is None:
            return None
